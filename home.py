...
root = tk.Tk()
root.title("Heart Disease Detection System using SVM")
w, h = root.winfo_screenwidth(), root.winfo_screenheight()
root.geometry(f"{w}x{h}")
root.state('zoomed')

bg_image = Image.open("medics.jpeg")  
...
title_label = tk.Label(root, text="Heart Disease Detection System", 
                       font=("Arial", 30, "bold"), fg="white", bg="#1f4e78")
